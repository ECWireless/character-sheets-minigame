...
ResourceId constant _tableId = ResourceId.wrap(
  bytes32(abi.encodePacked(RESOURCE_TABLE, bytes14(""), bytes16("CardCounter")))
);
ResourceId constant CardCounterTableId = _tableId;
...
library CardCounter {
   ...
   * @notice Get value.
   */
  function _get(bytes32 key) internal view returns (uint8 value) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
